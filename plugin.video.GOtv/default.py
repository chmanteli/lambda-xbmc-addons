    ...
    def episodes(self):
        ...
        for episode in episodes:
            try:
                ...
                image = imdbDict[imdb]
                sort = date.replace('-','')
                self.list.append({'name': name, 'url': name, 'image': image, 'date': date, 'year': year, 'imdb': imdb, 'tvdb': '0', 'genre': '', 'plot': '', 'title': title, 'show': show, 'show_alt': show, 'season': season, 'episode': num, 'sort': sort})
            except:
                pass
